...
{Redmond, WA}
\BulletItem%
Design, prototype, develop, and test new features for service migrating
\BulletItem%
Monitor and analyze metrics and logs for service to ensure quality of service
\BulletItem%
Coordinate and plan work required for general availability of a cloud service
\Hide{%
\BulletItem%
Critique, discuss, and review design documents and pull requests
}
\BulletItem%
Debugged and implemented fixes for issues impacting customers' authentication
\BulletItem%
...
\GapNoBreak%
Familiar: C, Java, OCaml, Rust, SQL, Python
