...
Curious, spontaneous, and continuously learning software engineer dedicated to
writing performant, scalable software that fails gracefully. 3+ years of
industry experience developing and designing cloud services.
...
\SubBulletItem%
Improved service reliability from 1-2 nines to 4 nines over a 6 month period
...
Fluent: C\#, Swift, Haskell, shell scripting, Git, Vim, (Postgre)SQL
\GapNoBreak%
Familiar: JavaScript, React, C, Java, Azure, Rust, Python, OCaml\Hide{, Nix}
