...
\BulletItem%
Debug and implement fixes for issues impacting customers' authentication
\BulletItem%
Curate our team wiki, modernizing and contributing guides and documentation
\BulletItem%
Coordinated and planned work required for general availability of a cloud service
\BulletItem%
...
Fluent: Haskell, C\#, bash, sh, Microsoft Azure, git, Vim, Linux
\GapNoBreak%
Familiar: C, Java, OCaml, Rust, SQL, Python, Nix, Powershell
